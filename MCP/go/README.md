# SalesLoft Platform MCP Server

This MCP (Model Content Protocol) server provides access to SalesLoft Platform API functionality through HTTP, HTTPS, and STDIO transport modes.
