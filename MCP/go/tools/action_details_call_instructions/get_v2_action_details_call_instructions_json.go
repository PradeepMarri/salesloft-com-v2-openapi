...
func Get_v2_action_details_call_instructions_jsonHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v2/action_details/call_instructions.json%s", cfg.BaseURL, queryString)
...
func CreateGet_v2_action_details_call_instructions_jsonTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v2_action_details_call_instructions_json",
		mcp.WithDescription("List call instructions"),
		mcp.WithArray("ids", mcp.Description("IDs of call instructions to fetch.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v2_action_details_call_instructions_jsonHandler(cfg),
	}
}
