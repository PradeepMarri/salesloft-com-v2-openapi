...
func Get_v2_call_dispositions_jsonHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v2/call_dispositions.json%s", cfg.BaseURL, queryString)
...
func CreateGet_v2_call_dispositions_jsonTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v2_call_dispositions_json",
		mcp.WithDescription("List call dispositions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_v2_call_dispositions_jsonHandler(cfg),
	}
}
